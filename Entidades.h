...
enum tipoBloco { 
    // Rapunzel
    Movel, Fixo, FinalFixo, FinalFixoCompleto, FinalMovel, FinalMovelCompleto,
    // Sokkoban
    ApenasEmpurra, Parede, FinalTargetIncompleto, FinalTargetCompleto, ParedeQuebravel,
    // MiniFluffys
    DirecEsquerda, DirecDireita, FluffySpawnRight, FluffySpawnDown, FluffySpawnLeft, FluffySpawnUpwards, FluffyDestination
    };

enum estagios { Nenhum, Rapunzel, Sokkoban, MiniFluffys };
/*
...
class entidade
{
    public:
        ...
        void atualizaPos();
        void mexe(posicao _posLim, velocidade _vel, float speedMag);
        bool emMovimento();
...
class miniFluffy: public entidade
{
    private:
    ...
    public:
        ...
        void Rotaciona(bool clockwise);
        void SetMiniFluffy(posicao blockPos, int blockType);
        void setRotacao(velocidade r);
        bool colisaoVitoria();
};
...
class block: public entidade
{
    public:
        block();
        block(posicao p, int t, double alpha, int levelStage);
        block(posicao p, tipoBloco t, double alpha, int levelStage);
        ~block();
...
class LLBlocos
{
    ...
    public:
        ...
        void AdicionaBloco(posicao p, int t, int stageLevel, double alpha);
...
class torre
{
    ...
    public:
        ...
        tipoColisao ChecaColisaoPlayer(player * pl, torre * tr);

        string TorreToString();

        bool coordenadaOcupada (posicao p);
        bool FaseCompleta(int levelStage);
};
